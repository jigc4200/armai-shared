...
def decrypt_api_key(encrypted_text: str) -> str:
    ...
    try:
        ...
        logger.error(
            "Failed to decrypt API key: Invalid token (wrong encryption key or corrupted data)"
        )
...
def encrypt(data: str) -> str:
    """
    Encrypt arbitrary text using Fernet.
...
def decrypt(data: str) -> str:
    """
    Decrypt arbitrary text using Fernet.

    Args:
        data: Encrypted text (base64-encoded)
